...
interface GovernanceCatalogMSSQLTreeViewProps {
  items: GovernanceItem[];
  onItemClick?: (item: GovernanceItem) => void;
}

const GovernanceCatalogMSSQLTreeView: React.FC<GovernanceCatalogMSSQLTreeViewProps> = ({ items, onItemClick }) => {
...
export default GovernanceCatalogMSSQLTreeView;
