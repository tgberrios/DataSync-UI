...
interface GovernanceCatalogMariaDBTreeViewProps {
  items: GovernanceItem[];
  onItemClick?: (item: GovernanceItem) => void;
}

const GovernanceCatalogMariaDBTreeView: React.FC<GovernanceCatalogMariaDBTreeViewProps> = ({ items, onItemClick }) => {
...
export default GovernanceCatalogMariaDBTreeView;
