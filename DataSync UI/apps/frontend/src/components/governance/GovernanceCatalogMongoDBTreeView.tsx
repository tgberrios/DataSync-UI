...
interface GovernanceCatalogMongoDBTreeViewProps {
  items: GovernanceItem[];
  onItemClick?: (item: GovernanceItem) => void;
}

const GovernanceCatalogMongoDBTreeView: React.FC<GovernanceCatalogMongoDBTreeViewProps> = ({ items, onItemClick }) => {
...
export default GovernanceCatalogMongoDBTreeView;
