...
const DataLineageMSSQL = () => {
    ...
    return [
      {
        ...
        rows: [
          ...
          { label: 'Unique Instances', value: metrics.unique_instances },
      ...
      },
      {
        title: 'Execution',
        rows: [
          { label: 'Total Executions', value: formatNumber(metrics.total_executions) },
          { label: 'Avg Duration', value: formatTime(metrics.avg_duration_ms) },
        ],
      },
      {
        title: 'Discovery',
  ...
  }, [metrics, formatNumber, formatTime]);
