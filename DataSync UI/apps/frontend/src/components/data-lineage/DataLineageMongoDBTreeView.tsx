      ...
      <TreeNode key={edge.id}>
        ...
        >
          ...
          <span style={{ 
            ...
            {edge.target_collection || 'Unknown'}
          </span>
          ...
          {isExpanded && (
            <div style={{
              ...
              {edge.collection_name && (
                <div style={{ marginBottom: 4, fontFamily: 'Consolas' }}>
                  <strong style={{ color: asciiColors.foreground }}>Collection:</strong> <span style={{ color: asciiColors.muted }}>{edge.collection_name}</span>
                </div>
              )}
              <div style={{ marginBottom: 4, fontFamily: 'Consolas' }}>
